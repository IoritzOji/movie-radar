...
export const MovieDetail = () => {
  ...
  useEffect(() => {
    async function fetchMovie() {
      const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=${import.meta.env.VITE_API_KEY}&language=en-US&page=1`)
  ...
  return (
    <main className="dark:bg-gray-800 bg-white">
      <section className="flex gap-40 justify-center flex-wrap py-5">
